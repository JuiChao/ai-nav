        ...
        <div className="trust-page__container">
          {locale === 'en' ? (
            <>
              ...
              <p>Our Service contains links to third-party web sites or services that are not owned or controlled by AI Nav. We have no control over, and assume no responsibility for, the content, privacy policies, or practices of any third-party web sites or services. You further acknowledge and agree that AI Nav shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with the use of or reliance on any such content, goods, or services available on or through any such web sites or services.</p>
              ...
              <p>In no event shall AI Nav, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.</p>
            ...
            <>
              ...
              <h2>4. 其他网站的链接</h2>
              <p>我们的服务包含指向非 AI 导航所有或控制的第三方网站或服务的链接。我们无法控制任何第三方网站或服务的内容、隐私政策或做法，也不承担任何责任。您进一步承认并同意，对于因使用或依赖此类网站或服务上或通过此类网站或服务提供的任何此类内容、商品或服务而造成或据称造成的任何损害或损失，AI 导航概不直接或间接负责。</p>
              
              <h2>5. 免责声明</h2>
              <p>本网站上的信息“按原样”提供，不提供任何明示或暗示的陈述或保证。AI 导航对本网站上发现的信息和材料的完整性、准确性、可靠性或适用性不做任何陈述或保证。</p>

              <h2>6. 责任限制</h2>
              <p>在任何情况下，AI 导航及其董事、员工、合作伙伴、代理商、供应商或附属公司，均不对任何间接、附带、特殊、后果性或惩罚性损害（包括但不限于利润、数据、使用、商誉的损失或其他无形损失）负责，这些损害是由于您访问、使用或无法访问、使用服务而导致的。</p>

              <h2>7. 更改</h2>
              <p>我们保留自行决定随时修改或替换这些条款的权利。什么构成重大更改将由我们自行决定。在这些修订生效后，如果您继续访问或使用我们的服务，即表示您同意受修订后条款的约束。</p>

              <h2>8. 联系我们</h2>
              <p>如果您对这些条款有任何疑问，请<a href="/contact">联系我们</a>。</p>
            </>
          )}
        </div>
      </main>
