        ...
        <div className="trust-page__container">
          {locale === 'en' ? (
            <>
              ...
              <p>Thank you for using AI Nav as your trusted AI companion. If you have any suggestions or would like to submit a tool, please feel free to <Link href="/contact">contact us</Link>.</p>
            </>
          ) : (
            <>
              <h1>关于 AI 导航</h1>
              ...
              <p>感谢您使用 AI 导航作为您值得信赖的 AI 伴侣。如果您有任何建议或想提交工具，请随时<Link href="/contact">联系我们</Link>。</p>
            </>
          )}
        </div>
      </main>
