        ...
        <div className="trust-page__container">
          {locale === 'en' ? (
            <>
              ...
              <h2>6. Contact Us</h2>
              <p>If you have any questions about this privacy policy or our privacy practices, please contact us at: <Link href="/contact">Contact Page</Link>.</p>
            </>
          ) : (
            <>
              <h1>隐私政策</h1>
              ...
              <h2>6. 联系我们</h2>
              <p>如果您对本隐私政策或我们的隐私惯例有任何疑问，请联系我们：<Link href="/contact">联系页面</Link>。</p>
            </>
          )}
        </div>
      </main>
